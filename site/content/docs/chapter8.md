...
This makes sending and receiving beacons quite simple. Here is how we send a beacon, using the <tt>zre_udp</tt> class to do the nonportable network calls:
