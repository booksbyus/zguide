No-one has translated the zmsg_test example into Python yet.  Be the first to create
zmsg_test in Python and get one free Internet!  If you're the author of the Python
