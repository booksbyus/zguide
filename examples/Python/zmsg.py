No-one has translated the zmsg example into Python yet.  Be the first to create
zmsg in Python and get one free Internet!  If you're the author of the Python
