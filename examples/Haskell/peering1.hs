No-one has translated the peering1 example into Haskell yet.  Be the first to create
peering1 in Haskell and get one free Internet!  If you're the author of the Haskell
