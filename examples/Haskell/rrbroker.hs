No-one has translated the rrbroker example into Haskell yet.  Be the first to create
rrbroker in Haskell and get one free Internet!  If you're the author of the Haskell
