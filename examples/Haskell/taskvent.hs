No-one has translated the taskvent example into Haskell yet.  Be the first to create
taskvent in Haskell and get one free Internet!  If you're the author of the Haskell
