No-one has translated the syncpub example into Haskell yet.  Be the first to create
syncpub in Haskell and get one free Internet!  If you're the author of the Haskell
