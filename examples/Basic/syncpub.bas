No-one has translated the syncpub example into Basic yet.  Be the first to create
syncpub in Basic and get one free Internet!  If you're the author of the Basic
